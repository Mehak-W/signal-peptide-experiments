...
def make_figure(ablation_data, cv_data, arch_data):
    ...
    arch_mses.append(0.932)  # reported best from Script 10
...
def main():
    ...
    print(f"    {'(256, 256, 128)':<20} {'0.932':>8} {'0.979':>11}")
    ...
    # ── Figure ────────────────────────────────────────────────────────────
    make_figure(ablation_data, cv_data, arch_data)
