...
Approach:
  ...
  5. Compare: LOGO MSE vs standard test MSE (0.932)
...
N_BOOTSTRAP = 10_000
STANDARD_TEST_MSE = 0.932  # From Script 10 (5-seed ensemble, full data)
...
def main():
    ...
    results = {
        ...
        'standard_comparison': {
            'standard_test_mse_5seed': STANDARD_TEST_MSE,
    ...
    # ── Figure ────────────────────────────────────────────────────────────
    make_figure(gene_results, unique_genes, logo_mse, logo_ci)
