...
def search_one_feature_type(name, X_train, X_test, y_train, y_test, rng):
    ...
    for i, config in enumerate(configs):
        ...
        # Preprocess with the sampled log_transform setting
        X_tr_p, X_te_p, y_tr_p, y_te_p, prep_info = preprocess(
        ...
        # Train/val split
        X_tr, y_tr, X_val, y_val = train_val_split(X_tr_p, y_tr_p, VAL_FRACTION, rng)
