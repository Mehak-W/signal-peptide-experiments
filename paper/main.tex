...
Moreover, the dropout rate (0.35) was selected based on test set MSE rather than a held-out validation set, so the reported improvement should be interpreted as an upper bound on out-of-sample performance; a proper nested cross-validation design would provide a less optimistic but more rigorous estimate.
