...
\midrule
ESM2-650M (1280d) & NN & \textbf{0.391} & \textbf{0.404} & \textbf{4.02} & 71.9 \\
PhysChem (156d) & NN & 0.379 & 0.392 & 4.04 & 71.6 \\
PhysChem (156d) & RF & 0.366 & 0.375 & 4.07 & \textbf{73.7} \\
...
The ESM2-650M NN achieves the highest rank correlation ($\rho = 0.391$), slightly outperforming the PhysChem NN (0.379), PhysChem RF (0.366), and ESM2-650M RF (0.363).
RF models achieve marginally better classification accuracy (73.7\% PhysChem, 72.9\% ESM2-650M) than NNs (71.6--71.9\%).
...
Generating ESM2-650M embeddings for the design variants and evaluating all four model--feature combinations reveals that the ESM2-650M NN achieves the highest rank correlation ($\rho = 0.391$), though the improvement over PhysChem features is modest (0.391 vs.\ 0.379 for NN, 0.363 vs.\ 0.366 for RF).
...
Applied to designed variants using both physicochemical and ESM2-650M features, the models achieve classification accuracy of 72--74\% and Spearman $\rho$ up to 0.391, demonstrating practical utility for guiding experimental prioritization.
